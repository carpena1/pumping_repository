#simulate havis loam experiment using hydrus template files
...
#by rainfall pumping 
#sources: havis 1992and 1986 higashino 2014
...
#experimental data L
deptha=c(-0.13,-0.31,-0.46,-0.50,-0.65,-0.78,-1.08,-0.96,-1.26,-1.43,-2.16,-2.79,-3.43,-4.42)
conca=c(0.00045,0.00121,0.00151,0.00189,0.00271,0.00274,0.00287,0.00396,0.00392,0.00358,0.00369,0.00404,0.00400,0.00400)

#name of parameter file
para.filename='parameters.csv'

#name of hydrus folder with reference files to copy
hydrus.filename='havisL'
...
for (i in 1:nrow(parameters)){
  ...
  table=cbind(time,rep(0,n),rep(0,n),rep(0,n),rep(0,n),rep(0,n),rep(0,n),round(htop*100,4),rep(0,n),rep(0,n),rep(0,n),rep(0,n),rep(0,n))
	...
	lines.to.write2=c("Pcp_File_Version=4"
	                  ...
	                  ,"      0          0"
	                  ,"   thr     ths    Alfa      n         Ks       l"
	                  ,stri_join(c(thetar[i],0.58,alpha[i],ns[i],Ksat[i],0.5),collapse='   ')
	                  ...
	                  , stri_join(c(1.1,disp[i],1,0),collapse='   ')
